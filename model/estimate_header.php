...
class estimate_header extends baseIdentity{
    ...
    public function save(){
        if ($insert_stmt =$this->db()->prepare("
            ...
            $insert_stmt->bind_param('iissssddddsi',$this->id,$this->company,$this->client_to,$this->client_address,$this->date_due,$this->observations,$this->subtotal,$this->tax,$this->taxAmount,$this->total,$this->dateDocument,$this->user);    
